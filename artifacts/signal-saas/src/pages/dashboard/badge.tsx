...
function PendingBadge() {
  return (
    <div className="w-full max-w-xs border-2 border-dashed border-border rounded-2xl flex flex-col items-center justify-center p-12 text-center gap-3">
      ...
      <p className="text-xs text-muted-foreground leading-relaxed">Your digital badge will appear here once your VIA application is approved and your VIA number is assigned.</p>
    </div>
  );
}
...
export default function DashboardBadge() {
  ...
  const downloadSvg = () => {
    ...
    a.href = url;
    a.download = `VIA-badge-${viaNumber}.svg`;
    a.click();
  ...
  return (
    <DashboardLayout>
      <div className="p-8 max-w-3xl">
        ...
        <p className="text-muted-foreground mb-8">Download your digital VIA badge and share your referral code.</p>

        <div className="grid md:grid-cols-2 gap-6">
          {/* Badge download */}
          <div className="bg-card border border-border rounded-2xl p-6">
            <h2 className="font-bold mb-1">Your VIA Badge</h2>
            ...
            <div className="flex justify-center mb-5">
              {isApproved ? (
                ...
                >
                  ...
                  <text x="80" y="38" fontFamily="Inter, sans-serif" fontSize="10" fontWeight="600" fill="#22c55e" letterSpacing="3">VIA SECURED</text>
                  ...
                  <text x="220" y="210" fontFamily="Inter, sans-serif" fontSize="9" fill="#475569" textAnchor="end">viasecured.co.uk</text>
                </svg>
              ) : (
                <PendingBadge />
              )}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-card border border-border rounded-2xl p-6">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed mb-4">
                Physical VIA stickers for your vehicle — one of the most visible trust signals in the trade. Included with your membership.
              </p>
